...
public class ModBoatEntity extends Boat {
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case PADOUK -> ModItems.PADOUK_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, Type.PADOUK.ordinal());
    }
    ...
    public static enum Type implements StringRepresentable {
        PADOUK(ModBlocks.PADOUK_PLANKS.get(), "padouk");
        ...
        public static ModBoatEntity.Type byName(String pName) {return CODEC.byName(pName, PADOUK);
        }
    }
}
