...
public class PadoukTrunkPlacer extends TrunkPlacer {

    public static final Codec<PadoukTrunkPlacer> CODEC = RecordCodecBuilder.create(padoukTrunkPlacerInstance ->
            trunkPlacerParts(padoukTrunkPlacerInstance).apply(padoukTrunkPlacerInstance, PadoukTrunkPlacer::new));

    public PadoukTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerType.PADOUK_TRUNK_PLACER.get();
    }
